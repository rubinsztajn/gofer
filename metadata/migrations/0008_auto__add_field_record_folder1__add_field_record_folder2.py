...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Record.folder1'
        db.add_column(u'metadata_record', 'folder1',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Record.folder2'
        db.add_column(u'metadata_record', 'folder2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Record.folder1'
        db.delete_column(u'metadata_record', 'folder1')

        # Deleting field 'Record.folder2'
        db.delete_column(u'metadata_record', 'folder2')
