...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'metadata_image', 'image', self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Image.image'
        db.alter_column(u'metadata_image', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
