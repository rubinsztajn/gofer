...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Record.format'
        db.add_column(u'metadata_record', 'format',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)

        # Adding field 'Record.rights'
        db.add_column(u'metadata_record', 'rights',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Record.format'
        db.delete_column(u'metadata_record', 'format')

        # Deleting field 'Record.rights'
        db.delete_column(u'metadata_record', 'rights')
